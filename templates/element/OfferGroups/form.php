...
<div class="card border-info mb-4">
    <div class="card-header bg-info text-white">
        <i class="bi bi-info-circle"></i> Paramètres du groupe
    </div>
    <div class="card-body">
        <div class="mb-3">
            <label class="form-label"><i class="bi bi-tag"></i> Nom du groupe</label>
        ...
        <div class="mb-3">
            <label class="form-label"><i class="bi bi-shuffle"></i> Offre mixte (profil)</label>
            ...
            <div class="form-text text-muted">
                ...
                <p class="mb-1">
                    ...
                    l’offre mixte ne se forecast pas (need à 0) — elle sert seulement à affecter des agents
                    sur le profil mixte.
                </p>
                <p class="mb-1">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label class="form-label"><i class="bi bi-graph-up"></i> Source de forecast</label>
            ...
            <div class="col-md-6 mb-3 d-flex align-items-end">
                <div class="form-check mb-2">
                    <?= $this->Form->control('prefer_mixed', [
                        'type' => 'checkbox',
                        'label' => 'Préférence soft pour le profil mixte (défaut ON)',
...
<div class="card border-primary mb-4">
    <div class="card-header bg-primary text-white">
        <i class="bi bi-people"></i> Offres membres
    </div>
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered" id="members-table">
                <thead>
                    <tr>
...
<div class="d-flex justify-content-between">
    ...
    <?= $this->Form->button(
        '<i class="bi bi-check-circle mr-1"></i> Enregistrer',
